...
import com.android.tdsoft.trackingapp.database.LocContentProvider;
import com.android.tdsoft.trackingapp.database.LocTable;
...
public class TrackingActivity extends MapActivity{
    ...
    private OnClickListener mStopListener = new OnClickListener() {
        public void onClick(View v) {
            ...
            // still bound clients.
            stopService(new Intent(TrackingActivity.this, MyService.class));
        }
    };
    ...
    private void drawPath() {
        ...
        Barcode.GeoPoint[] points = getPoints();
	...
	private Barcode.GeoPoint[] getPoints() {
		Barcode.GeoPoint[] all;
		int count = 0;
        ...
        if(mCursor.getCount()!=0) {
            all = new Barcode.GeoPoint[mCursor.getCount()];
            
            if (mCursor.moveToFirst()) {
                do {
                   float lon = mCursor.getFloat(1);
                   float lat = mCursor.getFloat(2);
                   Barcode.GeoPoint point = new Barcode.GeoPoint((int)(lat*1E6), (int)(lon*1E6));
                   all[count] = point;
                   count++;
        	...
        	all = new Barcode.GeoPoint[1];
        	all[0] = new Barcode.GeoPoint(1,19240000,-99120000);
        }
    ...
    private class LineOverlay extends Overlay {
       ...
       private Barcode.GeoPoint gp1;
       private Barcode.GeoPoint gp2;

       public LineOverlay(Barcode.GeoPoint gp1, Barcode.GeoPoint gp2) {
           this.gp1 = gp1;
           this.gp2 = gp2;
       }
