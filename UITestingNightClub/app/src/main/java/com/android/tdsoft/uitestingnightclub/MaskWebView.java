 ...
 */
public class MaskWebView extends FrameLayout {
    //Constants
    ...
    public MaskWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public MaskWebView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (theme != null) {
            ...
            try {
                ...
                mPorterDuffXferMode = getModeFromInteger(
                        a.getInteger(R.styleable.MaskWebView_porterduffxfermode, 0));
    ...
    private Drawable loadMask(TypedArray a) {
        return a.getDrawable(R.styleable.MaskWebView_mask);
    }
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = MaskWebView.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = MaskWebView.this.getViewTreeObserver();
                    }
